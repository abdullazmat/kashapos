    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <select
          ...
          className="rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm shadow-sm transition-all focus:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
        >
            ...
            <div className="flex gap-1">
              ...
              {Array.from(
                ...
                <button
                  key={p}
                  onClick={() => setPage(p)}
                  className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${page === p ? "bg-gradient-to-r from-teal-500 to-emerald-600 text-white shadow-sm" : "text-gray-600 hover:bg-gray-100"}`}
                >
                  {p}
                </button>
              ))}
        ...
        >
          ...
          >
            ...
            <div className="flex justify-end gap-2 border-t border-gray-100 px-6 py-4">
              ...
              <button
                onClick={saveProduct}
                className="rounded-xl bg-gradient-to-r from-teal-500 to-emerald-600 px-5 py-2.5 text-sm font-medium text-white shadow-md shadow-teal-500/25 transition-all hover:shadow-lg"
              >
                ...
                {categories.map((c) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-2 rounded-full bg-gradient-to-r from-teal-400 to-emerald-500" />
              ...
              <div className="border-t border-gray-100 pt-4">
                ...
                <div className="space-y-2.5">
                  ...
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-teal-500 to-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-md shadow-teal-500/25 transition-all hover:shadow-lg disabled:opacity-50 disabled:shadow-none"
                  >
                    Add Category
                  </button>
                </div>
